...
namespace benchmark {
using TaskFunction = std::function<void(const std::string&, const std::string&, const std::string&, const std::string&,
...
class Runner {
 public:
    ...
    void
    Run(std::string task_name, const std::string& index_type, const std::string& data_path,
        const std::string& index_path, const std::string& metric_type, std::ofstream& result_out) {
